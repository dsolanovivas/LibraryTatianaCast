...
const urlCargarLibros = "http://localhost:8080/Libro/obtenerLibroCategoria/4";
...
function mostrarLibros(listaLibros) {
    let table = document.querySelector('#categoria_artes');
    table.innerHTML = "";
    let ct = "";
...
function buscarLibro() {
    ...
    let strBusqueda = document.getElementById("busquedaLibroArte").value;
    ...
    var requestOptions = {
      ...
      fetch("http://localhost:8080/Libro/obtenerLibroCategoriaNombre/"+ strBusqueda + "/4", requestOptions)
