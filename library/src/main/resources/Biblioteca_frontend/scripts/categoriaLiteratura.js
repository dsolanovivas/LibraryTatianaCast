...
const urlCargarLibros = "http://localhost:8080/Libro/obtenerLibroCategoria/3";
...
function mostrarLibros(listaLibros) {
    let table = document.querySelector('#categoria_literatura');
    table.innerHTML = "";
    let ct = "";
...
function buscarLibro() {
    ...
    let strBusqueda = document.getElementById("busquedaLibroLiteratura").value;
    ...
    var requestOptions = {
      ...
      fetch("http://localhost:8080/Libro/obtenerLibroCategoriaNombre/"+ strBusqueda + "/3", requestOptions)
