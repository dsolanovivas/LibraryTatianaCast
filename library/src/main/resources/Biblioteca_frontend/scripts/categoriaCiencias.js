...
const urlCargarLibros = "http://localhost:8080/Libro/obtenerLibroCategoria/1";
...
function mostrarLibros(listaLibros) {
    let table = document.querySelector('#categoria_ciencias');
    table.innerHTML = "";
    let ct = "";
...
function buscarLibro() {
    ...
    let strBusqueda = document.getElementById("busquedaLibroCiencias").value;
    ...
    var requestOptions = {
      ...
      fetch("http://localhost:8080/Libro/obtenerLibroCategoriaNombre/"+ strBusqueda + "/1", requestOptions)
